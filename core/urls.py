...
urlpatterns = [
    ...
    path('admin-panel/photos/<int:photo_id>/primary/', views.admin_make_primary_photo_view, name='admin_make_primary_photo'),
    path('admin-panel/photos/<int:photo_id>/reorder/', views.admin_reorder_secondary_photo_view, name='admin_reorder_secondary_photo'),
